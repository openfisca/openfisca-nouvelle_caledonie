...
class ccs(Variable):
    ...
    def formula_2015(individu, period, parameters):
        ...
        ccs = parameters(period).prelevements_obligatoires.prelevements_sociaux.contribution_caledonienne_solidarite
        revenus_d_activite = (
            individu('salaire_de_base', period)
            )
        revenus_de_remplacement = individu.empty_array()  # TODO: Implement this variable
        revenus_epargne_patrimoine = individu.empty_array()  # TODO: Implement this variable
        contribution = (
